...
print "set pm3d map\n";
print "set pm3d interpolate 0,0\n";
...
sub draw_view($$$$$) {
	...
	my $lane_label =	$_[4];		# view label within the lane
	my $row_c =			$_[5];		# row number within the lane
...
# palette definitions
# more ideas at http://www.bmsc.washington.edu/people/merritt/gnuplot/demo_canvas/pm3dcolors.html
...
$rowcounter = &draw_view(	$N_tag,		0,		0.2,		$N_palette,	'fraction\nNs',		$rowcounter);
$rowcounter = &draw_view(	$A_tag,		0.2,		0.4,		$NT_palette,	'fraction\nAs',		$rowcounter);
$rowcounter = &draw_view(	$T_tag,		0.2,		0.4,		$NT_palette,	'fraction\nTs',		$rowcounter);
$rowcounter = &draw_view(	$G_tag,		0.2,		0.4,		$NT_palette,	'fraction\nGs',		$rowcounter);
$rowcounter = &draw_view(	$C_tag,		0.2,		0.4,		$NT_palette,	'fraction\nCs',		$rowcounter);
